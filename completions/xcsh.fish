...
complete -c xcsh -n "__fish_use_subcommand" -a "other" -d 'Other'
...
complete -c xcsh -n "__fish_seen_subcommand_from admin_console_and_ui" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from api" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from authentication" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from bigip" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from billing_and_usage" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from blindfold" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from bot_and_threat_defense" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from cdn" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from ce_management" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from certificates" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from cloud_infrastructure" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from container_services" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from data_and_privacy_security" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from data_intelligence" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from ddos" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from dns" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from managed_kubernetes" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from marketplace" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from network" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from network_security" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from nginx_one" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from object_storage" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from observability" -a "spec" -d 'Show resource specification (schema and AI guide)'
complete -c xcsh -n "__fish_seen_subcommand_from other" -a "list" -d 'List resources'
complete -c xcsh -n "__fish_seen_subcommand_from other" -a "get" -d 'Get a specific resource'
complete -c xcsh -n "__fish_seen_subcommand_from other" -a "create" -d 'Create a new resource'
complete -c xcsh -n "__fish_seen_subcommand_from other" -a "delete" -d 'Delete a resource'
complete -c xcsh -n "__fish_seen_subcommand_from other" -a "replace" -d 'Replace a resource'
complete -c xcsh -n "__fish_seen_subcommand_from other" -a "apply" -d 'Apply configuration from file'
complete -c xcsh -n "__fish_seen_subcommand_from other" -a "status" -d 'Get resource status'
complete -c xcsh -n "__fish_seen_subcommand_from other" -a "patch" -d 'Patch a resource'
complete -c xcsh -n "__fish_seen_subcommand_from other" -a "add-labels" -d 'Add labels to a resource'
complete -c xcsh -n "__fish_seen_subcommand_from other" -a "remove-labels" -d 'Remove labels from a resource'
complete -c xcsh -n "__fish_seen_subcommand_from other" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from rate_limiting" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from secops_and_incident_response" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from service_mesh" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from shape" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from sites" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from statistics" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from support" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from telemetry_and_insights" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from tenant_and_identity" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from threat_campaign" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from users" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from virtual" -a "spec" -d 'Show resource specification (schema and AI guide)'
...
complete -c xcsh -n "__fish_seen_subcommand_from vpm_and_node_management" -a "spec" -d 'Show resource specification (schema and AI guide)'
