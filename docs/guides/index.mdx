---
title: Examples
description: Real-world examples for common xcsh use cases
---
...
| Example | Description |
|---------|-------------|
| [AI Assistant Guide](/guides/ai-services-guide/) | Using the AI assistant for natural language queries |
| [Load Balancers](/guides/load-balancer/) | HTTP and TCP load balancer configuration |
| [Cloud Sites](/guides/cloud-sites/) | AWS and Azure site deployment |
