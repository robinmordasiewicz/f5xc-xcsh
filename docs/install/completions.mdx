...
description: Enable comprehensive tab completion for all xcsh commands
---
...
# Suggests: default, production, staging, etc. (from your tenant)
...
2. Check your network connectivity to the API
