...
export const generatedDescriptions: GeneratedDescriptionsData = {
  ...
  domains: {
    login: {
      ...
      medium:
        "Store named credential profiles for multiple tenants, switch active connection contexts, verify session state, and display environment banners.",
      ...
      subcommands: {
        profile: {
          ...
          medium:
            "Store named credential sets for different environments, switch between active connections, and remove outdated entries.",
        ...
        context: {
          ...
          medium:
            "Configure, display, and switch the active namespace scope. Commands automatically target this namespace when no explicit --namespace flag is provided.",
    ...
    cloudstatus: {
      ...
      medium:
        "Query operational health, view active incidents, track scheduled maintenance windows, and verify component availability across deployment regions.",
    ...
    completion: {
      ...
      medium:
        "Create shell-specific scripts enabling tab-assisted input for commands, subcommands, and flags in bash, zsh, or fish environments.",
