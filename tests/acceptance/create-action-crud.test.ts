    ...
    const successMatrix: CreateActionTestCase[] = [
      {
        ...
        command:
          "origin_pool --yes --yes --name test-pool --port 80 --public-ip 1.2.3.4",
        initialContext: { domain: "virtual", action: "create" },
        expectedAPICall: {
      ...
      {
        description:
          "create origin pool with multiple public IPs (repeatable flag)",
        command:
  ...
  describe("origin_pool create - failure scenarios", () => {
    const failureMatrix: CreateActionTestCase[] = [
      ...
      },
      {
        ...
        command:
          "origin_pool --yes --yes --name test-pool --private-ip 10.0.0.1",
        initialContext: { domain: "virtual", action: "create" },
        expectedOutput: {
      ...
      },
      {
        ...
        command:
          "origin_pool --yes --yes --name test-pool --public-ip 1.2.3.4 --port 99999",
        initialContext: { domain: "virtual", action: "create" },
        expectedOutput: {
