...
const mockHTTPLoadBalancer = {
  ...
  spec: {
    ...
    default_route_pools: [
      {
        pool: { name: "origin-pool-canada", namespace: "r-mordasiewicz" },
        weight: 1,
      },
    ],
...
describe("Acceptance: Get Action Argument Parsing", () => {
  ...
  describe("positional name after flags (bug fix)", () => {
    const bugFixTestMatrix: GetActionTestCase[] = [
      {
        description:
          "name after --namespace flag: virtual get http_loadbalancer --namespace ns name",
        command:
      ...
      {
        description:
          "name after -ns flag: virtual get http_loadbalancer -ns ns name",
      ...
      {
        description:
          "name after multiple flags: --namespace ns --output json name",
        command:
          "http_loadbalancer --namespace r-mordasiewicz --output json canadian-http-lb",
        initialContext: { domain: "virtual", action: "get" },
        expectedAPICall: {
          pathPattern: /\/http_loadbalancers\/canadian-http-lb/,
          method: "GET",
      ...
      },
      {
        ...
        command:
          "http_loadbalancer --namespace r-mordasiewicz --no-color canadian-http-lb",
        initialContext: { domain: "virtual", action: "get" },
        expectedAPICall: {
          pathPattern: /\/http_loadbalancers\/canadian-http-lb/,
          method: "GET",
  ...
  describe("positional name before flags (regression)", () => {
    const regressionMatrix: GetActionTestCase[] = [
      {
        description:
          "name before --namespace flag: resourceType name --namespace ns",
        command:
          "http_loadbalancer canadian-http-lb --namespace r-mordasiewicz",
        initialContext: { domain: "virtual", action: "get" },
        expectedAPICall: {
          pathPattern: /\/http_loadbalancers\/canadian-http-lb/,
          method: "GET",
      ...
      },
      {
        ...
        command:
          "http_loadbalancer --output json canadian-http-lb --namespace r-mordasiewicz",
        initialContext: { domain: "virtual", action: "get" },
        expectedAPICall: {
          pathPattern: /\/http_loadbalancers\/canadian-http-lb/,
          method: "GET",
