...
describe("exitCodeDescription", () => {
  it("should return correct descriptions", () => {
    ...
    expect(exitCodeDescription(ExitCode.AuthError)).toBe(
      "Authentication or authorization failure",
    );
    expect(exitCodeDescription(ExitCode.NotFoundError)).toBe(
      "Resource not found",
    );
    expect(exitCodeDescription(ExitCode.QuotaExceeded)).toBe(
