...
import { Suggestions, type Suggestion } from "../../src/repl/components/Suggestions.js";

describe("Suggestions Keyboard Behavior", () => {
	const mockSuggestions: Suggestion[] = [
		{ label: "create", value: "create", description: "Create a resource", category: "action" },
		{ label: "list", value: "list", description: "List resources", category: "action" },
		{ label: "show", value: "show", description: "Show resource details", category: "action" },
	];
