  ...
  describe("HTTP methods", () => {
    ...
    describe("PUT", () => {
      it("should make PUT request with body", async () => {
        ...
        await client.put(
          "/api/config/namespaces/shared/healthchecks/test",
          body,
        );
...
describe("buildResourcePath", () => {
  ...
  it("should handle various resource types", () => {
    expect(buildResourcePath("config", "origin_pools", "list", "shared")).toBe(
      "/api/config/namespaces/shared/origin_pools",
    );

    expect(buildResourcePath("config", "healthchecks", "list", "shared")).toBe(
      "/api/config/namespaces/shared/healthchecks",
    );

    expect(buildResourcePath("config", "app_firewalls", "list", "shared")).toBe(
      "/api/config/namespaces/shared/app_firewalls",
    );
  });
});
