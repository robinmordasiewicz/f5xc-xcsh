...
describe("parseCommandArgs", () => {
  ...
  const coreTestMatrix: TestCase[] = [
    ...
    {
      description:
        "name AFTER flags: get http_loadbalancer --namespace ns resource-name",
      args: [
        "http_loadbalancer",
        "--namespace",
        "r-mordasiewicz",
    ...
    {
      description:
        "name BEFORE flags: get http_loadbalancer resource-name --namespace ns",
      args: [
        "http_loadbalancer",
        "canadian-http-lb",
        "--namespace",
    ...
    {
      description:
        "name via --name flag: get http_loadbalancer --namespace ns --name resource-name",
      args: [
        "http_loadbalancer",
        "--namespace",
        "r-mordasiewicz",
    ...
    {
      description:
        "treats unknown type as resource name when no domainResourceTypes",
    ...
    {
      description:
        "treats unknown type as resource name when not in domainResourceTypes",
      args: ["unknown_resource"],
      domainResourceTypes: new Set(["http_loadbalancer"]),
      expected: {
        resourceType: undefined,
